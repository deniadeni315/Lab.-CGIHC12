...
int main() {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.Use();
        glm::mat4 model = glm::mat4(1); //figura
        glm::mat4 view = glm::mat4(1); //Camara
        ...
        model = glm::mat4(1); //Tercer cubo
        model = glm::translate(model, glm::vec3(1.2f, 3.0f, 0.0f));
        model = glm::rotate(model, 0.5f, glm::vec3(0.0f, 3.0f, 0.0f)); // use to compare orthographic and perspective projection
        model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f));
        glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
        glDrawArrays(GL_TRIANGLES, 0, 36);


        model = glm::mat4(1); //Cuarto cubo
